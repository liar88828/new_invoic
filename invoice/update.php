...
$id = $_GET['id'];
if (isset($id)) {
  $invoice = $invoiceObj->readSingle($id);
  $productsDB = $productObj->readAllById($id) ?: [];
  $customersDB = $customerObj->readAllById($invoice['id_customers']) ?: [];
//  print_r($customersDB);
//  print_r($customersDB);
}
...
// Calculate total
  ...
  $id_customer = $customerData[0]['id'] ?? $customersDB[0]['id'];
  $id_products = array();
...
//    ':id' => $id
  ...
  if ($invoiceObj->update($id, $data, $id_products)) {
    ...
    <form method="POST">
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="date" name="tanggal_invoice" class="form-control"
                       value="<?= htmlspecialchars($invoice['tanggal_invoice']) ?>" required>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="uang_muka" class="form-control"
                       value="<?= htmlspecialchars($invoice['uang_muka']) ?>" required>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="ongkir" class="form-control"
                       value="<?= htmlspecialchars($invoice['ongkir']) ?>" required>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="discount" class="form-control"
                       value="<?= htmlspecialchars($invoice['discount']) ?>" required max="100">
            </div>
            <input type="text" name="total" required hidden/>
        </div>
        ...
        <div class="mt-4">
            ...
            <table class="table table-bordered" id="invoiceTable">
                ...
                <?php foreach ($productsDB as $productDB): ?>
                    <tr>
                        <td>
                          <?= htmlspecialchars($productDB['id_produk']) ?>
                            <input type="hidden" name="products_id"
                                   value="<?= htmlspecialchars($productDB['id_produk']) ?>">
                        </td>
                        <td><?= htmlspecialchars($productDB['nama_produk']) ?></td>
                        <td class="jumlah-produk">
                          <?= htmlspecialchars($productDB['jumlah_produk']) ?>
                        </td>
                        <td class="harga-produk"><?= htmlspecialchars($productDB['harga_produk']) ?></td>
        ...
        <div class="mt-4">
            ...
            <table class="table table-bordered" id="customerTable">
                ...
                <?php foreach ($customersDB as $customerDB): ?>

                    <tr data-id="<?= htmlspecialchars($customerDB['id']) ?>">
                        <td>
        ...
        <!--      --><?php //= htmlspecialchars(json_encode(array($customersDB[0]))) ?>
        <input type="hidden"
               name="customer"
               id="customer"
               value="">
<!--      --><?php //= htmlspecialchars(json_encode($customersDB)) ?>
