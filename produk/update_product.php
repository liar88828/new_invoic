...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  $data = [
    ...
    ':total_produk' => $_POST['jumlah_produk'] * $_POST['harga_produk'],
...
<div class="container mt-5">
    ...
    <form method="POST">
        ...
        <div class="mb-3">
            ...
            <textarea name="keterangan_produk" class="form-control" rows="3"
                      required><?= htmlspecialchars($product['keterangan_produk']) ?></textarea>
        </div>
        <div class="mb-3">
